...
my $read_path_triticum = "/jic/scratch/groups/Philippa-Borrill/Ismael/data-trimmed/fastp-trim/GAZUL";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_TWD";
...
my $input_for_kallisto = "/jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_TWD/kallisto_input_GAZUL_TWD.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_TWD/slurm/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_TWD/slurm/%x.%N.%j.err
...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/kallisto.$sample"; # Do not forget create the tmp folder in where the output of kallisto will be saved
  ...
  print SLURM "set -e\n";
	...
	print SLURM "kallisto quant -i $index -o $output_dir/$sample -t 8 --pseudobam $pair_1_R1 $pair_1_R2 $pair_2_R1 $pair_2_R2 \n"; # --pseudobam is followed by each array pdefines above

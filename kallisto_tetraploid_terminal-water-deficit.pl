...
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/REGALLO_CS_reference/REGALLO_TWD";
...
my $input_for_kallisto = "/jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/REGALLO_CS_reference/REGALLO_TWD/kallisto_input_REGALLO_TWD.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/REGALLO_CS_reference/REGALLO_TWD/slurm/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/REGALLO_CS_reference/REGALLO_TWD/slurm/%x.%N.%j.err

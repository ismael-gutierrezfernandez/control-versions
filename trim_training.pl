...
my $output_dir = "/hpc-home/zik25cof/rna-training/Trimm/results/treatment"; # Define the directory where trimmed files were will be stored (output)

## Secondly we specified the input of the samples. Previously, we need to make a .txt file with all the samples (see examples):
my $input_list_dir = "/hpc-home/zik25cof/rna-training/Trimm/inputs"; # Path for the folder where the list of samples is stored
my $input_for_trim = "/hpc-home/zik25cof/rna-training/Trimm/inputs/trim_input_treatment_L007.txt"; # Path for the list.txt of samples itself
...
#SBATCH -c 4
#SBATCH --mem=120000
#SBATCH -o /hpc-home/zik25cof/rna-training/Trimm/results/treatment/slurm_output/%x.%N.%j.out
#SBATCH -e /hpc-home/zik25cof/rna-training/Trimm/results/treatment/slurm_output/%x.%N.%j.err

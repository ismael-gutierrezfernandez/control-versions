...
# script obtained from Philippa.borrill, modified by Arunkumar Ramesh
#
...
my $read_path_triticum = "/hpc-home/zik25cof/rna-training/Trimm/results/treatment";
my $output_dir = "/hpc-home/zik25cof/rna-training/kallisto/results/treatment";
...
my $input_for_kallisto = "/hpc-home/zik25cof/rna-training/kallisto/results/treatment/kallisto_input_treatment.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /hpc-home/zik25cof/rna-training/kallisto/results/treatment/slurm_output/%x.%N.%j.out
#SBATCH -e /hpc-home/zik25cof/rna-training/kallisto/results/treatment/slurm_output/%x.%N.%j.err

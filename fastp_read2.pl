...
my $input_for_trim = "/jic/scratch/groups/Philippa-Borrill/Ismael/data-trimmed/inputs/trimm_input_REGALLO_read2.txt";
...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/trim.$sample";
  ...
  print SLURM "source package fastp-0.20.0\n";
	...
	print SLURM "fastp --in1 $f1 --in2 $f2 --out1 $output_dir/$sample/$sample"."_1.read2.trimmed.fq.gz --out2 $output_dir/$sample/$sample"."_2.read2.trimmed.fq.gz -l 80 -g --detect_adapter_for_pe\n";

...
my $read_path_triticum = "/hpc-home/zik25cof/rna-training/Trimm/results/control";
my $output_dir = "/hpc-home/zik25cof/rna-training/kallisto/results";
...
my $input_for_kallisto = "/hpc-home/zik25cof/rna-training/kallisto/results/control/kallisto_input_control.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /hpc-home/zik25cof/rna-training/kallisto/results/slurm_output/%x.%N.%j.out
#SBATCH -e /hpc-home/zik25cof/rna-training/kallisto/results/slurm_output/%x.%N.%j.err

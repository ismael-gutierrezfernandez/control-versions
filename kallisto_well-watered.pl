...
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_WW";
...
my $input_for_kallisto = "/jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_WW/kallisto_input_GAZUL_WW.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_WW/slurm/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_WW/slurm/%x.%N.%j.err

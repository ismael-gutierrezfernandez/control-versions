...
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_LWD";
...
my $input_for_kallisto = "/jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_LWD/kallisto_input_GAZUL_LWD.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_LWD/slurm/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Ismael/pseudoalignment-kallisto/GAZUL_LWD/slurm/%x.%N.%j.err
